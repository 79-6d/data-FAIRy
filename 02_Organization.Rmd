...
A couple of tips from Jenny Bryan's [organization slides](http://www2.stat.duke.edu/~rcs46/lectures_2015/01-markdown-git/slides/organization-slides/organization-slides.pdf) that are worth to be mentioned: 
...
To be regular expression and globbing friendly, file names should avoid having:
...
File name that tells you about the file content saves you time. Similarly, using delimiters as mentioned above helps to make the file name more readable.
